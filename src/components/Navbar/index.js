    ...
    <div className={navStyles.footer}>
        {(!isMobileView)?(<div className={[navStyles.navbar]}>
            <div className={navStyles.navLeft}>
                <a className={navStyles.navlink} href="#landing">Home</a>
                <a className={navStyles.navlink} href="#events">Events</a>
                <a className={navStyles.navlink} href="#highlights">Features</a>
            </div>
            ...
            <div className={navStyles.navRight}>
                <a className={navStyles.navlink} href="#sponsor">Sponsors</a>
                <a className={navStyles.navlink} href="">FAQS</a>
                <a className={navStyles.navlink} href="#footer">Contact Us</a>
            </div>
        </div>):(
            <>
